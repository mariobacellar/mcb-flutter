...
class OrigemAtendimentoDDB extends StatefulWidget{
  @override
  _OrigemAtendimentoDDBState createState() => _OrigemAtendimentoDDBState();
}

class _OrigemAtendimentoDDBState extends State<OrigemAtendimentoDDB> {
